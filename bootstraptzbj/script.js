...
// 				});
	...
	$(document).on('click', '.fg-add-widget', function() {
		...
		var widget = $('<div class="fg-widget"><i class="fa fa-chevron-right fg-resize-widget"></i><i class="fa fa-times fg-remove-widget" title="remove this widget"></i><i class="fas fa-arrows-alt move-widget fg-widget-handle"></i><div class="fg-widget-inner" style="background: #406fff !important;"></div></div>');
